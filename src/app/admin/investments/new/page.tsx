    ...
    <div className="max-w-3xl space-y-6">
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-8">
        ...
        <section className="bg-white rounded-xl p-6 border border-slate-100 shadow-sm space-y-4">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div><label className="form-label">Total Amount Needed (₦) *</label><input type="number" min={0} {...register('totalAmount', { required: true, valueAsNumber: true })} className="form-input" placeholder="2000000000" /></div>
            <div><label className="form-label">Minimum Investment (₦) *</label><input type="number" min={0} {...register('minimumInvestment', { required: true, valueAsNumber: true })} className="form-input" placeholder="5000000" /></div>
          </div>
          <div className="grid grid-cols-2 gap-4">
