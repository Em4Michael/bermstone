  ...
  return (
    <div className="min-h-screen bg-[#FAFBFF] pt-20">
      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 py-14 space-y-8 text-slate-600 leading-relaxed">
        <div><h2 className="font-display text-xl font-semibold text-[#0B1F3A] mb-3">Company Information</h2><p><strong>Bermstone Real Estate Ltd</strong><br />Registered in the Federal Republic of Nigeria<br />Registered Address: Port Harcourt, Rivers State, Nigeria</p></div>
