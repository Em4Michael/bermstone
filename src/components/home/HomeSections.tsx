...
export function StatsSection() {
  const stats = [
    { value: '50+',  label: 'Premium Properties',   icon: '🏠' },
  ...
  return (
    <section className="py-16 bg-white border-b border-slate-100 relative overflow-hidden">
      <div className="absolute inset-0 pointer-events-none"
        style={{ backgroundImage: 'radial-gradient(circle at 20% 50%, rgba(30,95,190,0.04) 0%, transparent 50%), radial-gradient(circle at 80% 50%, rgba(201,168,76,0.04) 0%, transparent 50%)' }} />
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-6 reveal-stagger">
          {stats.map(({ value, label, icon }) => (
            <div key={label}
              ...
              <div className="text-3xl mb-2 animate-float inline-block" style={{ animationDelay: `${Math.random() * 2}s` }}>
                {icon}
              </div>
...
export function WhySection() {
  const reasons = [
    { icon: '🛡️', title: 'Fully Verified Properties',      desc: 'Every property is physically inspected and legally verified before listing on Bermstone.' },
    { icon: '📈', title: 'Transparent Investment Returns', desc: 'Detailed business plans, building plans, and clear ROI projections for every project.' },
    ...
    { icon: '🔑', title: 'Seamless Booking',               desc: 'Direct booking with no unnecessary fees. Fast confirmation and clear communication.' },
  ];
    ...
    <section className="py-24 bg-white relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16 reveal">
          ...
          <h2 className="section-title mt-1">Built on Trust. Driven by Excellence.</h2>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 reveal-stagger">
          {reasons.map(({ icon, title, desc }) => (
            <div key={title}
              ...
              <div className="w-14 h-14 rounded-2xl bg-[#EBF2FF] flex items-center justify-center mb-5 text-2xl
    ...
    <section className="py-24 bg-[#FAFBFF] overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16 reveal">
          ...
          <h2 className="section-title mt-1">Trusted by Guests &amp; Investors</h2>
        </div>
...
export function OwnerCTA() {
  return (
    <section className="py-24 bg-[#0B1F3A] overflow-hidden relative">
      ...
      <div className="absolute top-0 right-0 w-[500px] h-[500px] rounded-full opacity-10 pointer-events-none animate-float-slow"
        style={{ background: 'radial-gradient(circle, #1E5FBE, transparent)', filter: 'blur(60px)' }} />
      <div className="absolute bottom-0 left-0 w-80 h-80 rounded-full opacity-10 pointer-events-none animate-float"
        style={{ background: 'radial-gradient(circle, #C9A84C, transparent)', filter: 'blur(50px)', animationDelay: '2s' }} />
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 reveal-stagger">
          ...
          <div className="group relative bg-white/5 hover:bg-white/8 border border-white/10 hover:border-white/20 rounded-3xl p-9 transition-all duration-500 hover:shadow-2xl hover:shadow-blue-900/30">
            <div className="absolute top-6 right-6 text-4xl opacity-20 group-hover:opacity-40 transition-opacity animate-float">🏠</div>
            <div className="mb-6">
              ...
              <p className="text-blue-200 text-sm leading-relaxed">
                Let Bermstone manage your property and maximise your rental income. We handle everything while you earn consistently.
              </p>
            </div>
          ...
          <div className="group relative bg-white/5 hover:bg-white/8 border border-white/10 hover:border-[#C9A84C]/30 rounded-3xl p-9 transition-all duration-500 hover:shadow-2xl hover:shadow-yellow-900/20">
            <div className="absolute top-6 right-6 text-4xl opacity-20 group-hover:opacity-40 transition-opacity animate-float" style={{ animationDelay: '1s' }}>📈</div>
            <div className="mb-6">
              ...
              <p className="text-blue-200 text-sm leading-relaxed">
                Join investors funding landmark developments. Choose your project and earn returns backed by detailed business plans.
              </p>
            </div>
            <ul className="space-y-2.5 mb-8">
              {['Up to 45% expected ROI', 'Full project transparency', 'Business & building plans provided', 'Track your investment progress'].map(item => (
                <li key={item} className="flex items-center gap-2.5 text-sm text-blue-100">
